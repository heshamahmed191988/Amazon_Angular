...
import{CategoryProudectsComponent} from './Components/category-proudects/category-proudects.component'
export const routes: Routes = [
    {
        ...
        children: [
          ...
          //  {path: 'Home', component: OrderComponent},
            ...
            { path: 'category/:id', component: CategoryProudectsComponent } ,
            { path: 'CategoryProudectsComponent/:id', component: CategoryProudectsComponent }
